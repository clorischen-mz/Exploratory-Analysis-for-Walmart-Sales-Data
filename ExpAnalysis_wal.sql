...
FROM sales;
-- Answer: There are data for 6 product lines at Walmarts from the sales table, including automotive, clothing and apparel, electronics, groceries, health and wealness, and sports and outdoors.
...
-- Answer: Customers with memberships at Walmart bought slightly more often than those who're non-members. 
